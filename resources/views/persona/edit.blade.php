            ...
            <div class="col-md-12 crud_pais">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ url('/persona') }}" title="Back"><button class="btn btn-warning btn-informacion" style=" margin-top:-10vh; margin-left:12vh; color: #fff"><i class="fa fa-arrow-left" aria-hidden="true"></i> Atras</button></a>
                        <br />
