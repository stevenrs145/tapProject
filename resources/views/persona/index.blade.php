    ...
    <div class="row">
        ...
        <div class="col-12 crud_pais">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ url('/persona/create') }}" class="btn btn-success btn-sm btn-crear" title="Add New Persona">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                       <th>Departamento Id</th><th>Nombre Completo</th><th class="title_action">Acciones</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($persona as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->depto_id }}</td><td>{{ $item->nombre_completo }}</td>
                                        <td class="form_buttoms">
                                            <a href="{{ url('/persona/' . $item->id) }}" title="View Persona"><button class="btn btn-info btn-informacion btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> Ver</button></a>
                                            <a href="{{ url('/persona/' . $item->id . '/edit') }}" title="Edit Persona"><button class="btn btn-primary btn-editar btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Editar</button></a>
